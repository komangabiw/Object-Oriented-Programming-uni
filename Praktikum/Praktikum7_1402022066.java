...
public class Praktikum7_1402022066 {
    ...
    public static void battle(Object a, Object b){
        ...
        do {
            ...
            System.out.println("Memakai jurus -> " + ((HaveUltimateAbility)player1).getPowerName() +" Dengan Damage Jurus -> " + ((HaveUltimateAbility)player1).getPower()); 
            System.out.println("Memakai senjata -> " + ((Weaponed)player1).getWeaponName() + " Dengan Damage Senjata -> " + ((Weaponed)player1).getWeaponPower());
            
            System.out.println("Total serangan " + player1.getCharacterName() + " Ke karakter " + player2.getCharacterName() + " Adalah " + ((HaveUltimateAbility)player1).attack());
            System.out.println("==============================================");
